 ...
 * Use the {@link YoungProducts#newInstance} factory method to
 * create an instance of this fragment.
 */
public class YoungProducts extends Fragment {
    private FragmentKitchenBinding binding;

    List<FurnitureModel> list_young = new ArrayList<>();
    MAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adapter.setList_m(list_young);
        binding.rvKitchenRoom.setAdapter(adapter);
        return root;
    }

    private void createList() {
        list_young.add(new FurnitureModel("kitchen", "Стол Прованс" ,
        ...
        list_young.add(new FurnitureModel("kitchen", "Стол Лесной Ручей" ,
        ...
        list_young.add(new FurnitureModel("kitchen", "Стол Мраморный Взгляд" ,
        ...
        list_young.add(new FurnitureModel("kitchen", "Стол Фьюжн Декор" ,
        ...
        list_young.add(new FurnitureModel("kitchen", "Стол Скандинавский Бриз" ,
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnBack.setOnClickListener(v->{
            ...
            navController.navigate(R.id.action_youngProducts_to_navigation_home);
        });
